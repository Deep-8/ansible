...
const Location = () => {
    const {
        allLocation, columns, isFetching,
        pagination, showDeleteModal,
        onDelete,
        editLoading,
        showModal,
        showEditModal,
    ...
    return (
        <div>
            <div className='flex justify-between my-4 items-center gap-x-4 gap-y-4 flex-wrap'>
                ...
                <ButtonComponent text="Add Location" clickFn={handleShowAddLocationModal} />
            </div>
                    ...
                    <Row gutter={30}>
                        <Col xs={24} md={24}>
                            ...
                            >
                                <Input
                                    style={{ width: '100%' }}
                                    placeholder="Enter Location Name" allowClear />
                            </Form.Item>
                        </Col>
