...
const Skills = () => {
    const { allSkills, handleShowDeleteModal, onDelete, showDeleteModal, showEditModal, handleAddSkill, initialValues, addLoading, editLoading, columns, isFetching, pagination, onSearch, showModal, handleShowAddSkillsModal } = useSkills();
    return (
        <div>
                    ...
                    <Row gutter={30}>
                        <Col xs={24} md={24}>
                            ...
                            >
                                <Input
                                    style={{ width: '100%' }}
                                    placeholder="Enter Skill Name" allowClear />
                            </Form.Item>
                        </Col>
