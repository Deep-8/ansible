...
const RequirementViewModal = () => {
  ...
  return (
    <Card className="mt-10" headStyle={{background:"#30007E0D"}} title={<span className="text-2xl font-semibold">Requirement Details</span>}>
      {detailLoadingRequirements ? (
        <Skeleton active />
      ) : (
          <div>
            <Row>
              <Col className="text-lg mt-5" xs={24} sm={24} md={12} lg={12} xl={12}>
